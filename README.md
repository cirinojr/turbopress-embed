...
```
cd existing_repo
git remote add origin https://gitlab.smartquiz31.com/wordpress-skallar/skallar-form-v6.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.smartquiz31.com/wordpress-skallar/skallar-form-v6/-/settings/integrations)
