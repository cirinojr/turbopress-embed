  ...
  const createPreview = () => {
    ...
    return (
      <>
        ...
        >
          <div className="icons">
            <svg viewBox="0 0 20 20" class="like-icon" focusable="false">
              <path
            ...
            <svg viewBox="0 0 20 20" class="watch-later-icon" focusable="false">
              <path
            ...
            <svg
              ...
              class="share-icon ShareButton_module_shareIcon__da819942"
              focusable="false"
            >
              <path
          ...
          <div className="controls">
            <span className="play">
              <svg
                ...
                data-play-icon="true"
                class="PlayButton_module_playIcon__fc6bec57"
              >
                <path
            ...
            <span className="ctrlbar">
              ...
              <svg viewBox="0 0 24 24" data-volume-icon="true">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                class="PrefsButton_module_gearIcon__61ec289e"
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
